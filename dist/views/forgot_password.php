...
<head>
    ...
    <title>Forgot Password - Pemandian</title>
    ...
    <div class="login-form-inner">
      ...
      <form method="post" action="" id="form">
        <div class="login-form-group">
            ...
            <input type="text" placeholder="Masukkan username atau email anda" id="email" name="email" required>
        </div>
        <!-- <div class="login-form-group">
      ...
      <div class="register-div">Sudah ingat dengan akun anda? <a href="login.php" class="link create-account" -link>Login</a></div>
      <div class="register-div">Atau belum mempunyai akun? <a href="register.php" class="link create-account" -link>Daftar Sekarang</a></div>
    </div>
